...
interface PropertyTypeSuggestionModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const PropertyTypeSuggestionModal: React.FC<PropertyTypeSuggestionModalProps> = ({
  isOpen,
  onClose
}) => {
      ...
      {step === 'suggestion' ? (
        ...
        <div className="p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-2 pr-8">
            Are we missing your property type?
          </h2>
          
          <p className="text-gray-600 mb-6">
            Help us complete our list by telling us what kind of property you&apos;d like to list.
          </p>
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-4">
            We&apos;ll use your suggestion to improve our list to better match travelers to their perfect property.
          </p>
          
          <p className="text-gray-600 mb-6">
            For now, please select the closest match to your property type.
          </p>
